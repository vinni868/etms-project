...
CREATE TABLE `course_trainer` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_ct_course` (`course_id`),
  KEY `fk_ct_trainer` (`trainer_id`),
  CONSTRAINT `fk_ct_course` FOREIGN KEY (`course_id`) REFERENCES `course_master` (`id`),
  CONSTRAINT `fk_ct_trainer` FOREIGN KEY (`trainer_id`) REFERENCES `users` (`id`)
...
INSERT INTO `course_trainer` VALUES (1,1,1),(2,1,6),(3,4,1),(5,3,6),(6,1,1);
