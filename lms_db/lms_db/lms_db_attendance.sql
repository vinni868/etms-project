...
CREATE TABLE `attendance` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_attendance` (`scheduled_class_id`,`student_id`),
  KEY `student_id` (`student_id`),
  KEY `marked_by` (`marked_by`),
  CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`scheduled_class_id`) REFERENCES `scheduled_classes` (`id`) ON DELETE CASCADE,
